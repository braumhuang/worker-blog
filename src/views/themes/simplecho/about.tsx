    ...
    <div class="sc-post-container">
      <article class="sc-post-detail sc-about-page">
        <div class="sc-about-profile">
          {options.about_avatar ? <img src={publicAttachmentUrl(options.about_avatar, options.file_cdn_url)} alt={options.site_title} /> : <div class="sc-about-initial">{Array.from(options.site_title)[0] || "S"}</div>}
          <h1>{options.site_title}</h1>
          {options.site_description ? <p>{options.site_description}</p> : null}
          <div class="sc-about-social">{links.map(([icon, label, href]) => href ? <a href={href} aria-label={label} title={label} target={icon === "mail" ? undefined : "_blank"} rel={icon === "mail" ? undefined : "noopener noreferrer"}><Icon name={icon} /></a> : null)}</div>
        </div>
