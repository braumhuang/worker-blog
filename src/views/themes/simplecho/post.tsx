    ...
    <div class="sc-post-container">
      <article class="sc-post-detail">
        ...
        <div class="sc-post-info-detail">
          <time datetime={new Date(content.released * 1000).toISOString()}>
            发布于 ·{" "}
          ...
          <span>
            {" "}
            · {wordCount(content.text)} 字 · 约 {readingMinutes(content.text)}{" "}
            分钟
          </span>
        </div>
        {cover ? (
          <figure class="sc-post-feature-banner">
