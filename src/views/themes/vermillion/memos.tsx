  ...
  return (
    <>
      <Masthead
        en="Memos"
        zh="闪念"
        tagline="Tiny presences. Not articles, just shimmer."
        date={magazineDate(Math.floor(Date.now() / 1000), timeZone)}
        extra={
          <>
            <strong class="vermillion memo-count">{total}</strong> 条 · 活跃{" "}
            {activeDays} 天
          </>
        }
      />
      {days.length ? (
        <div class="memo-heatmap fade-in" style="animation-delay:0.2s">
          ...
          <div class="memo-heatmap-info">
            <span>过去一年 · A year in small marks</span>
